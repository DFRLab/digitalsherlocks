...
''' File contains assets to process Twitter data
'''

# creating functions
def database_tweet_keys(key):
    '''
    '''
    db_keys = {
        'users': [
...
# Order columns to insert data into sql database
def order_columns_to_sql(key):
    ''' Orders columns
    '''
    columns = {
        'media_tweet': [
